...
class CategoryContainer extends React.Component {
    ...
    handlePageClick = data => {
        ...
        this.setState({ 
            offset,
            apiUrl: "https://magnews24h.herokuapp.com/api/articles/" + this.state.catName + "?limit=10&page=" + (selected + 1)
        }, () => {
            this.addZero();
            this.loadArticles();
    ...
    UNSAFE_componentWillMount() {
        Categories
            ...
            .map(e => this.setState({ 
                ...
                catType: e.type,
                nameCategory: e.name,
                apiUrl: "https://magnews24h.herokuapp.com/api/articles/" + e.categoryName + "?limit=10&page=1"
            }));
    }
